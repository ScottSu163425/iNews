...
public class ImageCacheFileUtils {
    private static final String CHCHEDIR = "ImgCache";//缓存目录
    ...
    private static ImageCacheFileUtils instance = null;

    //单例模式
    public static ImageCacheFileUtils getInstance() {
        if (instance == null) {
            synchronized (ImageCacheFileUtils.class) {
                if (instance == null) {
                    instance = new ImageCacheFileUtils();
                }
            }
        }
        return instance;
